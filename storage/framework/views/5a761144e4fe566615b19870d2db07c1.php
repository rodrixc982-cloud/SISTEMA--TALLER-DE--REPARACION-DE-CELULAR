                ...
                <?php if($errors->any()): ?>
                    <div class="alert alert-danger">
                        <?php $__currentLoopData = $errors->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $e): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div style="font-size:13px;"><i class="fas fa-exclamation-circle me-1"></i><?php echo e($e); ?></div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                <?php endif; ?>

                <form id="formVenta" action="<?php echo e(route('ventas.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                            ...
                            <select id="selectProducto" class="form-select" style="max-width:220px;">
                                ...
                                <?php $__currentLoopData = $productos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($p->id); ?>"
                                            data-nombre="<?php echo e($p->nombre); ?>"
                                            data-precio="<?php echo e($p->precio_venta); ?>"
                                            data-stock="<?php echo e($p->stock); ?>"
                                            data-codigo="<?php echo e($p->codigo); ?>">
                                        <?php echo e($p->nombre); ?> (<?php echo e($p->stock); ?> disp.)
                                    </option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
    ...
    <div class="col-lg-4">
        <div class="card" style="position:sticky; top:90px;">
            <div class="card-body p-4">
                ...
                <a href="<?php echo e(route('ventas.index')); ?>" class="btn btn-outline-secondary w-100 mt-2 py-2">
                    Cancelar
                </a>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\crm-gestion-tienda-celulares\resources\views/ventas/create.blade.php ENDPATH**/ ?>