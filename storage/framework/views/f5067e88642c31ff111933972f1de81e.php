<?php $__env->startSection('title', 'Backup & Restauración'); ?>
    ...
    <div class="d-flex align-items-start justify-content-between flex-wrap gap-3" style="position:relative;z-index:1;">
        <div>
            ...
            <div class="d-flex flex-wrap gap-2 mt-3">
                <span class="stat-pill"><span class="dot" style="background:#10b981;"></span><?php echo e($stats['ventas']); ?> ventas</span>
                <span class="stat-pill"><span class="dot" style="background:#06b6d4;"></span><?php echo e($stats['clientes']); ?> clientes</span>
                <span class="stat-pill"><span class="dot" style="background:#a855f7;"></span><?php echo e($stats['productos']); ?> productos</span>
                <span class="stat-pill"><span class="dot" style="background:#f59e0b;"></span><?php echo e($stats['reparaciones']); ?> reparaciones</span>
            </div>
        </div>
        <div class="text-end" style="color:rgba(255,255,255,.8);">
            <div style="font-size:12px;margin-bottom:6px;">ÚLTIMO BACKUP</div>
            <?php if($stats['ultimo']): ?>
                <div style="font-size:18px;font-weight:700;"><?php echo e($stats['ultimo']->format('d/m/Y')); ?></div>
                <div style="font-size:12px;opacity:.7;"><?php echo e($stats['ultimo']->format('H:i:s')); ?></div>
            <?php else: ?>
                <div style="font-size:15px;font-weight:600;color:#fca5a5;">Sin backups aún</div>
            <?php endif; ?>
            <div style="margin-top:8px;font-size:12px;"><?php echo e($stats['backups']); ?> archivos · <?php echo e($stats['tamTotal'] > 0 ? number_format($stats['tamTotal']/1024,1).' KB' : '0 KB'); ?> total</div>
        </div>
    </div>
</div>
    ...
    <div class="col-lg-4">
        <div class="card action-card">
            <div class="card-body p-4">
                ...
                <form action="<?php echo e(route('backup.crear')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                ...
                <div class="d-flex align-items-center justify-content-between mb-3">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            ...
                            <small class="text-muted"><?php echo e($stats['backups']); ?> archivos guardados</small>
                        </div>
                    </div>
                </div>
                ...
                <div style="max-height:300px;overflow-y:auto;padding-right:4px;">
                    ...
                    <div class="backup-item">
                        ...
                        <div class="flex-grow-1" style="min-width:0;">
                            <div style="font-size:12px;font-weight:600;color:#374151;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;" title="<?php echo e($bk['nombre']); ?>">
                                <?php echo e(Str::limit($bk['nombre'], 28)); ?>

                            </div>
                            <div style="font-size:11px;color:#9ca3af;">
                                <?php echo e($bk['fecha']->format('d/m/Y H:i')); ?> ·
                                <?php
                                    $b = $bk['tamanio'];
                        ...
                        <div class="d-flex gap-1">
                            <a href="<?php echo e(route('backup.descargar', $bk['nombre'])); ?>"
                            ...
                            <form action="<?php echo e(route('backup.eliminar', $bk['nombre'])); ?>" method="POST"
    ...
    <div class="col-lg-4">
        <div class="card action-card">
            <div class="card-body p-4">
                ...
                <form action="<?php echo e(route('backup.restaurar')); ?>" method="POST" enctype="multipart/form-data" id="formRestore">
                    <?php echo csrf_field(); ?>
                    ...
                    <?php $__errorArgs = ['archivo_sql'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                        <div class="text-danger" style="font-size:12px;margin-top:-8px;margin-bottom:10px;"><?php echo e($message); ?></div>
                    <?php unset($message);
...
<div class="danger-zone">
    ...
    <form action="<?php echo e(route('backup.resetear')); ?>" method="POST" id="formReset">
        <?php echo csrf_field(); ?>
        ...
        <?php $__errorArgs = ['tipo_reset'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
            <div class="text-danger mb-3" style="font-size:12px;"><?php echo e($message); ?></div>
        <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
        ...
        <div class="confirm-box" id="confirmBox" style="display:none;">
            <div class="row align-items-center g-3">
                <div class="col-md-6">
                    ...
                    <?php $__errorArgs = ['confirmacion'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                        <div class="text-danger" style="font-size:12px;margin-top:4px;"><?php echo e($message); ?></div>
                    <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\crm-gestion-tienda-celulares\resources\views/backup/index.blade.php ENDPATH**/ ?>