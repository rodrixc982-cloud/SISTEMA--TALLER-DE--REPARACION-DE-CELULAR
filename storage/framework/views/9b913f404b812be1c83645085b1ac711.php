...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'CRM'); ?> — Tienda Celulares</title>
...
<aside class="sidebar" id="sidebar">
    ...
    <div class="user-profile d-flex align-items-center gap-3">
        ...
        <div>
            ...
            <div class="user-role"><?php echo e(ucfirst(Auth::user()->rol)); ?></div>
        </div>
    </div>
    ...
    <nav class="sidebar-nav">
        ...
        <a href="<?php echo e(route('clientes.index')); ?>"
           class="nav-link <?php echo e(request()->routeIs('clientes.*') ? 'active' : ''); ?>">
            <span class="nav-icon"><i class="fas fa-users"></i></span>
            Clientes
        </a>

        <a href="<?php echo e(route('productos.index')); ?>"
           class="nav-link <?php echo e(request()->routeIs('productos.*') ? 'active' : ''); ?>">
            <span class="nav-icon"><i class="fas fa-box"></i></span>
            Inventario
        </a>

        <a href="<?php echo e(route('ventas.index')); ?>"
           class="nav-link <?php echo e(request()->routeIs('ventas.*') ? 'active' : ''); ?>">
            <span class="nav-icon"><i class="fas fa-shopping-cart"></i></span>
            Ventas
        </a>

        <a href="<?php echo e(route('reparaciones.index')); ?>"
           class="nav-link <?php echo e(request()->routeIs('reparaciones.*') ? 'active' : ''); ?>">
            <span class="nav-icon"><i class="fas fa-tools"></i></span>
            Reparaciones
            <?php $pendRep = \App\Models\Reparacion::where('estado','listo')->count(); ?>
            <?php if($pendRep > 0): ?>
                <span class="badge-count"><?php echo e($pendRep); ?></span>
            <?php endif; ?>
        </a>
        ...
        <a href="<?php echo e(route('reportes.index')); ?>"
           class="nav-link <?php echo e(request()->routeIs('reportes.*') ? 'active' : ''); ?>">
        ...
        <a href="<?php echo e(route('configuracion.index')); ?>"
           class="nav-link <?php echo e(request()->routeIs('configuracion.*') ? 'active' : ''); ?>">
            <span class="nav-icon"><i class="fas fa-cog"></i></span>
            Configuración
        </a>

        <a href="<?php echo e(route('backup.index')); ?>"
           class="nav-link <?php echo e(request()->routeIs('backup.*') ? 'active' : ''); ?>">
...
<div class="main-wrapper">
    ...
    <header class="topbar">
        ...
        <div class="topbar-actions">
            <a href="<?php echo e(route('ventas.create')); ?>" class="btn btn-sm btn-primary px-3" style="border-radius:20px;">
                <i class="fas fa-plus me-1"></i> Nueva Venta
            </a>

            <button class="topbar-btn">
                <i class="fas fa-bell"></i>
                <?php $stockBajoCount = \App\Models\Producto::whereColumn('stock','<=','stock_minimo')->count(); ?>
                <?php if($stockBajoCount > 0): ?><span class="notif-dot"></span><?php endif; ?>
            </button>
    ...
    <main class="page-content">
        ...
        <nav class="mb-3" style="font-size:13px;">
            <ol class="breadcrumb mb-0" style="background:transparent; padding:0;">
                <li class="breadcrumb-item"><a href="<?php echo e(route('dashboard')); ?>" style="color:var(--accent1);">Inicio</a></li>
...
<?php /**PATH C:\laragon\www\crm-gestion-tienda-celulares\resources\views/layouts/app.blade.php ENDPATH**/ ?>