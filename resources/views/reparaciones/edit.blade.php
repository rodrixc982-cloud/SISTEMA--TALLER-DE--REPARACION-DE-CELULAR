...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">
        ...
        <a href="/reparaciones/{{ $reparacion->id }}" style="color: #a855f7;">
        ...
        <div class="card">
            <div class="card-body p-4">
                <div class="d-flex align-items-center justify-content-between mb-4">
                    ...
                    <!-- ⭐ CORREGIDO - Usando URL directa -->
                    <a href="/reparaciones/{{ $reparacion->id }}" class="btn btn-outline-secondary">
                ...
                <!-- ⭐ CORREGIDO - Usando URL directa -->
                <form action="/reparaciones/{{ $reparacion->id }}" method="POST">
                    @csrf 
                    @method('PUT')
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select name="garantia" class="form-select">
                                        <option value="0" {{ old('garantia',$reparacion->garantia) ? '' : 'selected' }}>No</option>
                                        <option value="1" {{ old('garantia',$reparacion->garantia) ? 'selected' : '' }}>Sí</option>
                                    </select>
                                </div>
                                <div class="col-md-3">
                    ...
                    <div class="d-flex gap-2 justify-content-end">
                        <!-- ⭐ CORREGIDO - Usando URL directa -->
                        <a href="/reparaciones/{{ $reparacion->id }}" class="btn btn-outline-secondary px-4">Cancelar</a>
