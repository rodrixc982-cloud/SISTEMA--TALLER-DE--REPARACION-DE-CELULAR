...
app('router')->setCompiledRoutes(
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::fQ3bGb5JLYD4bsMA',
          ),
          1 => NULL,
          2 => 
          array (
    ...
    2 => 
    array (
      0 => '{^(?|/c(?|lientes/([^/]++)(?|(*:31)|/edit(*:43)|(*:50))|onfiguracion/usuarios/([^/]++)(?|/toggle(*:98)|(*:105)))|/productos/([^/]++)(?|(*:137)|/edit(*:150)|(*:158))|/ventas/([^/]++)(?|(*:186)|/cancelar(*:203))|/reparaciones/([^/]++)(?|(*:237)|/edit(*:250)|(*:258))|/backup/(?|descargar/([^/]++)(*:296)|eliminar/([^/]++)(*:321)))/?$}sDu',
    ),
    3 => 
    array (
      31 => 
  ...
  array (
    ...
    array (
      ...
      'uri' => 'reparaciones/{reparacione}/edit',
      'action' => 
      array (
        'middleware' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'O:55:"Laravel\\SerializableClosure\\UnsignedSerializableClosure":1:{s:12:"serializable";O:46:"Laravel\\SerializableClosure\\Serializers\\Native":5:{s:3:"use";a:0:{}s:8:"function";s:556:"function () {
